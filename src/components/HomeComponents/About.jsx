...
const About = () => {
  return (
    <section className="flex flex-col items-center justify-center lg:my-28" id="about">
        ...
        <div className="flex gap-10">
          ...
          <div className="flex flex-col max-w-[600px] justify-between">
              ...
              <h3 className='text-4xl font-semibold mb-3'>Eu sou o Silpharny</h3>
              <h4 className='text-lg font-semibold mb-3'>
                Desenvolvedor <span className='text-violet-800'>Front-End</span> localizado no{" "}
                <span>Rio de Janeiro, Brasil</span>
              </h4>
              <p className='text-zinc-700 text-lg mb-4 pb-6 text-justify border-b-2 border-b-violet-200'>
            ...
            <ul className="flex gap-8 mb-5 justify-between">
